...
/home/ubuntu/app/spark-1.4.0-bin-hadoop2.3/bin/spark-submit --master local[3] --executor-memory 5g --driver-memory 3g  --class com.feel.statistics.MergeResultPlatform ../jar/feel-recommend-1.0-SNAPSHOT.jar "../data/$dir/platform" "../data/$dir/active_1days_platform" "../data/$dir/active_2days_platform" "../data/$dir/active_3days_platform" "../data/$dir/active_platform" "../data/$dir/nostop_platform"
